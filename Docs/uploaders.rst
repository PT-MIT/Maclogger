...
As a standalone unit, Maclogger is a very capable data logger
...
service. Maclogger has the capability to upload selected data 
while still maintaining all of its own local logging 
and reporting capabilities.

When one of these services becomes unavailable for any reason,
Maclogger will upload the backlog when service is restored,
whether that backlog is a minute or a month.

Maclogger can support multiple upload services simultaneously,
