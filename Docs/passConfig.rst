...
require authorization.  Maclogger supports two levels of authorization using the relatively secure 
...
Be sure to carefully note the password that you set, as Maclogger does not store the actual value and it cannot be recovered. 
