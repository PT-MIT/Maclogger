...
Maclogger file systems
---------------------

Maclogger has two file systems. 
...
Maclogger uses that area for limited device specific information. 
This file system uses a flat directory structure, however 
Maclogger presents it as hierarchical through the file manager.
...
*   Display file system
*   Delete files
*   Upload files to the Maclogger
*   Download files from the Maclogger
*   Edit files
...
Files can be uploaded to the Maclogger by clicking the 
...
the file to the Maclogger file system. You can edit the 
...
The Maclogger configuration app was developed exclusively 
using this editor and an Maclogger. 
