...
....
    ...
    and the "double" box checked to indicate to Maclogger that the voltage
...
Maclogger supports multiple voltage references, but as a practical
...
look at the status display of the Maclogger.  If reversed,
...
This indicates that Maclogger has recognized that the voltage and 
