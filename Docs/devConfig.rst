...
Use the url: ``http://Maclogger.local`` or, if your device
...
If you have more than one Maclogger you will need to do this so that they
each have unique names. When you press save, the Maclogger will restart using
...
Maclogger has DST rules for most of North America, Europe, Australia and New Zealand.

Auto-update Class
----------------- 

Auto-update Class tells Maclogger if you want to receive 
...
Maclogger checks the Maclogger.com site for new software regularly.
The update process takes less than a minute.
New firmware is authenticated with a digital signature from Maclogger and installed automatically.
