...
The good news is thatMaclogger supports a wide variety of readily available 
...
The CTs that are sold at the `Maclogger stuff store <http://stuff.Maclogger.com>`_  
...
The 3.5mm connectors plug into any of the 14 input channels on theMaclogger.
...
Not to worry, in the event some end up backward,Maclogger will still work, 
...
At this point, you should have theMaclogger up and running with the voltage 
...
**Allow negative power value**
    ...
    grid-tied solar (net-metering).  Checking this box tellsMaclogger 
...
**Reverse**
    ...
    current flow.  
   Maclogger will sense this and correct automatically in single-phase 
    ...
    is a necessity in three-phase installations because theMaclogger 
...
Each time you press save, the new configuration is sent toMaclogger 
...
When you have configured all of the CTs connected to theMaclogger, 
basic configuration is complete.
Click the |Status| button to see theMaclogger in action.
...
Maclogger. If your particular CT is not one of the dropdown models, 
...
Current type CTs are the most common type of CT used withMaclogger and
all of the CTs available in theMaclogger *Stuff* Store are of this type. 
...
voltage rather than current.  They are connected to a modifiedMaclogger 
input that has had the internal burden resistor removed and specified as zero 
in the device configuration burden menu. Maclogger will ask for a **Cal** 
